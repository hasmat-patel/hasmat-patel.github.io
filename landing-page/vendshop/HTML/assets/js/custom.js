...
function openNav() {
  ...
  if(!$(".mobile-view-data").hasClass('clonned')){
    $(".mobile-view-data").addClass('clonned');
    $("#header-right-div").clone(false).appendTo(".mobile-view-data");
  }
}
...
$(document).ready(function(){ 
  ...
  if ($('body').width() < 1025 ){
    $(".category-div").clone(false).appendTo("#view-category-root");
  }
 ...
 $(window).scroll(function() {
  ...
  var c, currentScrollTop = 0,
   navbar = $('.header-div');
    ...
    if (a <= 105) navbar.removeClass('header-bgcolor');
