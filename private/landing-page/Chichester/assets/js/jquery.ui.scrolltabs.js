        ...
        options: {
            scrollOptions: {
                ...
                customGotoFirstHTML: '<button class="stNavFirstArrow ui-state-active" title="First">' +
                    '<span class="ui-icon ui-icon-seek-first"><span class="material-icons">first_page</span></span></button>',
                customMoveNextHTML: '<button class="stNavNextArrow ui-state-active" title="Next">' +
                    '<span class="ui-icon ui-icon-seek-next"><span class="material-icons">arrow_right</span></span></button>',
                customGoToLastHTML: '<button class="stNavLastArrow ui-state-active" title="Last">' +
                    '<span class="ui-icon ui-icon-seek-end"><span class="material-icons">last_page</span></span></button>',
                customMovePreviousHTML: '<button class="stNavPrevArrow ui-state-active" title="Previous">' +
                    '<span class="ui-icon ui-icon-seek-prev"><span class="material-icons">arrow_left</span></span></button>',
                easing: 'swing',
                enableDebug: false,
